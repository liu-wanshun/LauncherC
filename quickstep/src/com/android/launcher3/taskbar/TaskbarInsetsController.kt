...
class TaskbarInsetsController(val context: TaskbarActivityContext) : LoggableTaskbarController {
    ...
    fun init(controllers: TaskbarControllers) {
        ...
        // TODO: Android13 QPR3 API
        //gestureNavSettingsObserver.registerForCallingUser()
        gestureNavSettingsObserver.register()
    }
    ...
    fun onTaskbarWindowHeightOrInsetsChanged() {
        ...
        for (provider in windowLayoutParams.providedInsets) {
            if (provider.type == navigationBars() || provider.type == mandatorySystemGestures()) {
                ...
                provider.insetsSize =
                    Insets.of(
                        24,//TODO: Android13 QPR3 API, gestureNavSettingsObserver.getLeftSensitivityForCallingUser(res),
                        0,
                        0,
                        0
                    )
                ...
                provider.insetsSize =
                    Insets.of(
                        0,
                        0,
                        24,//TODO: Android13 QPR3 API,gestureNavSettingsObserver.getRightSensitivityForCallingUser(res),
                        0
                    )
            }
        }
